...
<body class="bg-gray-100">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form) {
                form.addEventListener('submit', function(e) {
                    ...
                    const userDefaultStorage = document.querySelector('input[name="user_default_storage"]');
                    ...
                    if (userDefaultStorage && userDefaultStorage.value) {
                        userDefaultStorage.value = parseInt(userDefaultStorage.value) * 1048576;
                    }
        ...
        document.getElementById('new_extension').addEventListener('keypress', function(e) {
            if (e.key === 'Enter') {
                e.preventDefault();
                addExtension();
            }
